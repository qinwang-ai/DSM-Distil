...
from models.SSENet_Bagging import SSENet
...
def train(sse_loader, val_loader, ssenet, is_test=False):
    ...
    for epoch in range(1, config.epochs + 1):
        ...
        if is_test:
            ...
            f = open('./logs/real_psm8_bc40.txt', 'w')
            # f = open('./logs/real_psm8_6125.txt', 'w')
...
if __name__ == '__main__':
    ...
    sse_val_dataset = SSEDataset(config_tmp.psm_real_data_path.replace('train', 'valid'),
                                 ...
                                 enable_downsample=False, mode='all', config=config_tmp)
