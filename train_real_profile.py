    ...
    for epoch in range(1, config.epochs + 1):
        ...
        if not is_test:
            ...
            for batch in tqdm(sse_loader):
                ...
                optimizer.zero_grad()
                pred = ssenet(sequence, profile)  # 16 x 44 x 3
        ...
        if is_test:
            ...
            # f = open('logs/real_profile3_bc40.txt', 'w')
            # # f = open('logs/real_profile3_6125.txt', 'w')
...
if __name__ == '__main__':
    ...
    # config_bc_40 = config
    sse_val_dataset = SSEDataset(config_bc_40.profile_real_data_path.replace('train', 'valid'),
    ...
    # BEST ACC with BC40 < 5: 0.733
    # BEST ACC with BC40 < 3: 0.717
    # BEST ACC with BC40 < 60: 0.771
