...
# bins = [60, 50000000]
# bins = [2000, 400000000000]
bins = [-1, 60]
# bins = [-1, 30]
# bins = [-1, 10]
# bins = [-1, 1]

# bins = [-1, 30]     #  0.845 0.844 0.838
# bins = [30, 60]
# bins = [10, 30]
# bins = [30, 50]
# bins = [50, 70]
...
IUPAC_VOCAB = OrderedDict(
    [('A', 0), ('R', 1), ('N', 2), ('D', 3),
     ...
     ('H', 8), ('I', 9), ('L', 10),
     ('K', 11), ('M', 12), ('F', 13), ('P', 14),
     ('S', 15), ('T', 16), ('W', 17), ('Y', 18), ('V', 19), ('X', 20),('<pad>', 21)])

if num_labels == 3:
    sp_att_data_path = sp_att3_data_path
else:
    sp_att_data_path = sp_att8_data_path
...
# _meff_file = open(meff_file, 'r').readlines()
# high_quality_list = []
# low_quality_list =[]
# for line in _meff_file:
