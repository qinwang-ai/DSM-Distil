...
def try_get_pretrained(teacher, student, gradenet, scratch=False):
    ...
    student_path = '../module/bioinfo_student_wo_spf.pth'
    # gradenet_path = '../module/bioinfo_gradenet_wo_spf.pth'
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epochs != 1:
            ...
            for batch in tqdm(sse_loader):
                ...
                dsm = (low_dsm + fake_dsm)/2
                feats = (low_feats + fake_feats)/2
        ...
        if is_test:
            ...
            f = open('logs/our_wo_spf_acc3_bc40.txt', 'w')
...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        student = Student(input_dim=config.embed_dim + config.profile_width)
